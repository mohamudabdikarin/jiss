...
const parseArticleMultipartJson = require('../middleware/parseArticleFormJson');
...
router.post('/', uploadPDF, parseArticleMultipartJson, validate(createArticleValidator), articleController.createArticle);
router.put('/:id', uploadPDF, parseArticleMultipartJson, validate(updateArticleValidator), articleController.updateArticle);
