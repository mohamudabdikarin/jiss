...
exports.createPage = async (req, res, next) => {
  try {
    ...
    return successResponse(res, page, 'Page created', 201);
  } catch (error) { next(error); }
};
...
exports.updatePage = async (req, res, next) => {
  try {
    ...
    cacheService.invalidate('page');
    return successResponse(res, page, 'Page updated');
  } catch (error) { next(error); }
};
...
exports.reorderPages = async (req, res, next) => {
  try {
    ...
    cacheService.invalidate('page');
    return successResponse(res, null, 'Pages reordered');
  } catch (error) { next(error); }
};
...
exports.duplicatePage = async (req, res, next) => {
  try {
    ...
    if (!original) return errorResponse(res, 'Page not found', 404);
    ...
    return successResponse(res, newPage, 'Page duplicated', 201);
  } catch (error) { next(error); }
};
